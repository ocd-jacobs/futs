/* ----------------------------------------------------------------
 * <doc>
 * @purpose Generates an event if the argument is not null 
 *  (has non-zero length).
 * @param ARG1 - the argument to check for null
...
%macro assert_null( ARG1,
        MESSAGE=Non-null value <&ARG1>,
        TYPE=,
        LEVEL=,
        ATTACHDATA=,
        ATTACHFILE=,
