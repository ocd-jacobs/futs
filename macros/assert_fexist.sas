/* ----------------------------------------------------------------
 * <doc>
 * @purpose Generates an event if a file identified by fileref does not exist.
...
%macro assert_fexist( FILEREF,
        MESSAGE=Fileref &FILEREF does not exist,
        TYPE=,
        LEVEL=,
        ATTACHDATA=,
        ATTACHFILE=,
