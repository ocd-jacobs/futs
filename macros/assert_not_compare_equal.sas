/* ----------------------------------------------------------------
 * <doc>
 * @purpose Generates an event if two data sets are the same,
...
%macro assert_not_compare_equal( BASE=, COMPARE=, VAR=, CRITERION=, METHOD=,
        MESSAGE=Data set &COMPARE equal to &BASE,
        TYPE=,
        LEVEL=,
        ATTACHDATA=,
        ATTACHFILE=,
