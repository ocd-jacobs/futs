/* ----------------------------------------------------------------
 * <doc>
 * @purpose Generates an event if two arguments are not equal.
...
%macro assert_equal( ARG1, ARG2, DATATYPE=, PRECISION=1e-15,
        MESSAGE=Unequal values <&ARG1> and <&ARG2>,
        TYPE=,
        LEVEL=,
        ATTACHDATA=,
        ATTACHFILE=,
...
%assert_sym_compare( &ARG1, &ARG2, eq, DATATYPE=&DATATYPE, PRECISION=&PRECISION, 
        MESSAGE=&MESSAGE,
        TYPE=&TYPE,
        LEVEL=&LEVEL,
